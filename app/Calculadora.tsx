...
export default function Calculator() {
    ...
    const Accionar = (value: string) => {
        if (value === '=') {
            try {
                ...
                if (evaluar < 0 || evaluar > 999999999) {
                    setResult('ERROR');
                } else {
            ...
            setData(data.startsWith('-') ? data.slice(1) : '-' + data);
    ...
    return (
        <main style={{ display: 'flex', minHeight: '100vh', flexDirection: 'column', alignItems: 'center', padding: '24px' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '4rem',  boxShadow: '0 4px 6px rgba(0,0,0,0.1)',width: '100%', maxWidth: '400px', height: 'auto' 
    }}>
              <input
                    type="text"
